...
export default function FinalCta() {
  return (
    <>
      <section className="relative py-40 px-6 overflow-hidden cta-gradient">
        <div
        ...
        >
          <h2
            className="font-black tracking-tight leading-[0.95] mb-7"
            style={{ fontSize: 'clamp(36px, 5.5vw, 64px)' }}
          >
            Stop letting paid leads
            <br />
            <span className="text-gradient-orange">die cold.</span>
          </h2>
          <p className="text-[#71717A] text-lg mb-12 leading-relaxed">
            Every month you wait, your list gets colder.
          </p>
          <a
            href="#pricing"
            className="btn-arrow btn-orange inline-flex items-center gap-2 px-10 py-4 rounded-full text-white font-bold text-lg"
          >
      ...
      <footer className="border-t border-[#1A1A1A] bg-[#0A0A0A] px-6 py-8">
        ...
        <div className="max-w-6xl mx-auto mt-4 pt-4 border-t border-[#141414]">
          <p className="text-[#3F3F46] text-xs text-center">
            © 2026 ReWarm · AI Lead Reactivation for Real Estate
          </p>
        </div>
      </footer>
    </>
